...
- **Network requests:** None (the extension makes no external requests)

## Permissions

This extension requires no special Chrome permissions. It uses a content script that runs only on `skool.com`.
